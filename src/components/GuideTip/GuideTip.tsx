...
const GuideTip = () => {
  ...
  return (
    <div className="absolute w-3/4 md:w-auto bottom-5 left-1/2 transform -translate-x-1/2 bg-black/60 text-zinc-900 px-4 py-2 rounded-3xl shadow-md flex items-center justify-between z-10 border-blue-500 border-2 border">
